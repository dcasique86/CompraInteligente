...
import com.example.data.ConversionHistoryDao
import com.example.data.local.ProductPhotoDao
import com.example.domain.model.ProductPhoto

@Database(entities = [ConversionHistory::class, ProductPhoto::class], version = 2, exportSchema = false)
